...
export function DegreePlanning() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground">Degree Planning & Advising</h1>
        <p className="mt-2 text-muted-foreground">Track your progress towards degree completion</p>
      </div>
          ...
          <div className="relative pt-1">
            <div className="overflow-hidden h-4 text-xs flex rounded-full bg-blue-300">
              <div
                ...
                className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-card transition-all duration-500"
              ></div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {requirements && requirements.length > 0 && (
            <div className="bg-card rounded-lg shadow">
              <div className="px-6 py-4 border-b border-border">
                <h3 className="text-lg font-semibold text-foreground">Degree Requirements</h3>
              </div>
              <div className="p-6">
                      ...
                      <div key={req.id} className="border border-border rounded-lg p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center">
                            ...
                            <div>
                              <h4 className="text-lg font-medium text-foreground">{req.name}</h4>
                              {req.description && (
                        ...
                        {req.requiredCourses && req.requiredCourses.length > 0 && (
                          <div className="mt-3">
                            <details className="text-sm">
                              <summary className="cursor-pointer text-blue-600 dark:text-blue-400 hover:text-blue-700 font-medium">
                                  ...
                                  return (
                                    <div
                                      ...
                                      className={`flex items-center px-3 py-2 rounded ${
                                        isCompleted ? 'bg-green-50 text-green-800' : 'bg-muted/50 text-foreground'
                                      }`}
                                    >
                                      {isCompleted ? (
                                        ...
                                        <svg className="h-5 w-5 text-muted-foreground mr-2" fill="currentColor" viewBox="0 0 20 20">
          ...
          {degreeAudit && (
            <div className="bg-card rounded-lg shadow">
              <div className="px-6 py-4 border-b border-border">
                <h3 className="text-lg font-semibold text-foreground">Degree Audit</h3>
              </div>
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                    <div>
                      ...
                      <div className="text-lg font-semibold text-foreground">{degreeAudit.majorName}</div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-muted-foreground">Degree Type</div>
                      <div className="text-lg font-semibold text-foreground">{degreeAudit.degreeType}</div>
                    </div>
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 border border-border rounded-lg">
                      <div className="text-sm text-muted-foreground mb-1">Academic Standing</div>
                      <div className="text-xl font-bold text-foreground">{degreeAudit.academicStanding || 'Good Standing'}</div>
                    </div>
                    <div className="p-4 border border-border rounded-lg">
        ...
        <div className="lg:col-span-1">
          {advisor && (
            <div className="bg-card rounded-lg shadow sticky top-8">
              <div className="px-6 py-4 border-b border-border">
                <h3 className="text-lg font-semibold text-foreground">Academic Advisor</h3>
              </div>
              <div className="p-6">
                <div className="text-center mb-4">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-100 text-blue-600 dark:text-blue-400 text-3xl font-bold mb-3">
                    {advisor.fullName ? advisor.fullName.charAt(0).toUpperCase() : 'A'}
                  </div>
                  <h4 className="text-lg font-semibold text-foreground">{advisor.fullName}</h4>
                  <p className="text-sm text-muted-foreground">{advisor.title || 'Academic Advisor'}</p>
                </div>

                <div className="space-y-3 mt-6">
                  <div className="flex items-start">
                    <svg className="h-5 w-5 text-muted-foreground mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <div>
                      <div className="text-sm font-medium text-foreground">Email</div>
                      <a href={`mailto:${advisor.email}`} className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700">
                        {advisor.email}
                      </a>
                    </div>
                  </div>
                  ...
                  {advisor.phone && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href={`tel:${advisor.phone}`} className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700">
                          {advisor.phone}
                        </a>
                      </div>
                    </div>
                  ...
                  {advisor.office && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{advisor.office}</div>
                      </div>
                    </div>
                  )}
                  ...
                  {advisor.officeHours && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{advisor.officeHours}</div>
                      </div>
                    </div>
                  )}
                </div>
          ...
          <div className="mt-6 bg-card rounded-lg shadow">
            ...
            <div className="p-4">
              <div className="space-y-2">
                <a
                  href="/courses"
                  className="flex items-center p-3 text-sm text-foreground hover:bg-muted/50 rounded-lg transition-colors"
                >
